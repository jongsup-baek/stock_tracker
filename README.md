...
6. [stock_fetcher.py 주요 기능](#6-stock_fetcherpy-주요-기능)
7. [stock_fetcher.py 사용법](#7-stock_fetcherpy-사용법)
8. [GitHub Actions 자동 실행](#8-github-actions-자동-실행-)
9. [처음 설치하는 경우](#9-처음-설치하는-경우)
10. [CLI 문제 해결](#10-cli-문제-해결)
11. [참고사항](#11-참고사항)
